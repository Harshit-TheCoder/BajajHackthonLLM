...
system_prompt = (
    ...
    "If you don't know the answer, SAY 'Sorry, but your question is vague. These are the policies I know about , say your question with one of these policies' and DISPLAY {lic_policy}."
    "you are trained with these policies {lic_policy}"
